      ...
      <Select
        ...
        styles={{
          ...
          option: (styles, { isFocused, isSelected }) => ({
            ...styles,
            backgroundColor: isFocused ? isSelected ? '#c7aa35' : '#c7aa35' : '#2fcdf3',
            color: 'black',
            cursor: 'pointer',
          }),
    ...
    <div>
      ...
      <div className="GlobalContainer launches-all-padding">
        <div>
          ...
          <div className="max-w-7xl mt-100 mx-auto pt-36 pb-24 px-4 sm:px-12 sm:py-10" style={{marginTop: '100px'}}>
            {/* <div className='my-6 flex m-auto justify-center'>
              <Link to="/CreateTeleFun" className="transform transition-transform duration-200 hover:scale-110 rounded-full bg-[#2fcdf3] px-6 py-4 text-base sm:text-xl font-bold sm:font-extrabold border border-black h-[48px] sm:h-[79px] text-[22px] flex items-center" style={{ boxShadow: "rgb(0, 0, 0) 1px 3px 0px 0px" }}>
                Create Token
              </Link>
            </div> */}
